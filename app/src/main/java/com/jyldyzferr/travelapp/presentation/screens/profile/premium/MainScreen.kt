...
internal fun RenderListingScreen(
    ...
    Box(modifier = Modifier.fillMaxWidth()) {
        Image(
            painter = painterResource(state.selectedCountry.touristPlaces[state.selectedItemIndex].images),
...
internal fun WeatherView(
    ...
    Row(
        ...
        Image(
            painter = painterResource(R.drawable.tokyo_skytree_1),
            contentDescription = null,
            contentScale = ContentScale.Crop,
    ...
    LazyRow(
        ...
        items(items = imagesList, key = { item: TouristPlace -> item.name }) { touristPlace ->
            Card(
                ...
                Box {
                    Image(
                        painter = painterResource(touristPlace.images),
                        contentDescription = null,
                        modifier = Modifier
                            .aspectRatio(ratio = (295.0 / 432.0).toFloat())
